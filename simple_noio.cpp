...
int main(int argc, char * argv[])
{
	...
	cout<<"without IO, # of iteration = "<<m1<<", Inst retired = "<<measurements[0]/count<<" , IPC = "<<measurements[1]/count<<" , L1Misses = "<<measurements[2]/count<<" , L2Misses = "<<measurements[3]/count<<endl;    
	return 0;
}
